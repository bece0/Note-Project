...
<body>
    ...
    <form class="form" action="action/edit_course_action.php" method="POST" enctype="multipart/form-data" style="margin-top:25px;">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input  type="text"id="bolum_adi" name="bolum_adi" placeholder="" class="form-control" required                     
                             value="<?php echo $ders_detail['bolum_adi'] ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input  type="number" id="kontenjan" name="kontenjan" placeholder="" class="form-control" required="true" 
                    value="<?php echo $ders_detail['kontenjan'] ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input  type="text" id="sinif" name="sinif" placeholder="" class="form-control" required
                         value="<?php echo $ders_detail['sinif'] ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <textarea rows="3" id="aciklama" name="aciklama" placeholder="Ders detayını açıklayın..."
                            class="form-control" required="true" ><?php echo $ders_detail['aciklama'] ?></textarea>
                </div>
            </div>
       
            <div class="form-group row">
                <label class="col-md-2 control-label"><b>Ders Kapak Resmi</b></label>
                <div class="col-sm-10">
                    <div class="input-group">
                        <input type="file" name="ders_resim" id="ders_resim" accept="image/x-png,image/jpeg">
                    </div>
                </div>
    ...
    <script>
        ...
        $("#ders_resim").change(function() {
            console.log("ders_resim inputu değişti");
            ...
            if(dosyaBoyutMB > maxFilesize){
                ...
                document.getElementById("ders_resim").value = "";
                this.value = null;

                $('#preview').attr('src', '');

                // var secilen_tip = $("#tip").val();
                $('#preview').attr('src', "files/images/default.png");
