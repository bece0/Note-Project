...
<div class="card card-comments mb-3 wow fadeIn">
    ...
    <div class="card-body">
        ...
        <div class="media d-block d-md-flex comment-container <?php if($onay_durum == 0) echo "onaysiz"; ?>"
            ...
            <img class="comment-avatar d-flex mb-3 mx-auto"
                src="files/profile/<?php echo $current_comment["kullanici_id"] ?>.png" alt="<?php echo $adi_soyadi ?>"
                title="<?php echo $adi_soyadi ?>" onerror="this.onerror=null; this.src='files/profile/profile.png'">
            <div class="media-body text-center text-md-left ml-md-3 ml-0 commment-block">
                <h6 class="mt-0 font-weight-bold comment-title">
                    ...
                    <button href="#" class="btn btn-sm comment-action float-right btn-danger delete-comment" title="Sil"
                        comment-id="<?php echo $comment_id ?>">
    ...
    <div class="card-body">
        <form id="comment-form">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="comment" id="txt_comment" rows="3" maxlength="500"
                    placeholder="Yorumunuz buraya yazabilirsiniz..."></textarea>
            </div>
    ...
    $(".delete-comment").on("click", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#comment-' + comment_id).fadeOut(1200, function() {
                    $(this).remove();
                });
            },
            error: function(jqXHR, error, errorThrown) {
